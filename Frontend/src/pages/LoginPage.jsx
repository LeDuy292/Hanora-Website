...
const DECK_COVERS = [
  {
    title: "HSK 1 Standard",
    badge: "HSK 1",
    chars: "你好",
    pinyin: "nǐ hǎo",
    desc: "Chân Trời Mới",
    color:
      "from-emerald-600/80 to-teal-950/90 text-emerald-400 border-emerald-500/30",
    bgImage: cover1,
  },
  {
    title: "HSK 2 Standard",
    badge: "HSK 2",
    chars: "朋友",
    pinyin: "péngyou",
    desc: "Kết Nối Bạn Bè",
    color: "from-blue-600/80 to-indigo-950/90 text-blue-400 border-blue-500/30",
    bgImage: cover2,
  },
  {
    ...
    chars: "汉语",
    pinyin: "Hànyǔ",
    desc: "Mở Rộng Tầm Nhìn",
    color:
      "from-purple-600/80 to-violet-950/90 text-purple-400 border-purple-500/30",
    bgImage: cover3,
  },
  {
    title: "Đường Thi Tuyển Tập",
    badge: "Thơ Đường",
    chars: "唐诗",
    pinyin: "Tángshī",
    desc: "Văn Học Cổ Điển",
    color:
      "from-amber-700/80 to-amber-950/90 text-amber-400 border-amber-500/30",
    bgImage: cover1,
  },
  {
    ...
    chars: "再见",
    pinyin: "zàijiàn",
    desc: "Hội Thoại Đời Sống",
    color: "from-rose-600/80 to-rose-950/90 text-rose-400 border-rose-500/30",
    bgImage: cover2,
  },
  {
    title: "Du Lịch Bắc Kinh",
    badge: "Du Lịch",
    chars: "故宫",
    pinyin: "Gùgōng",
    desc: "Khám Phá Trung Hoa",
    color: "from-cyan-600/80 to-cyan-950/90 text-cyan-400 border-cyan-500/30",
    bgImage: cover3,
  },
  {
    ...
    chars: "饺子",
    pinyin: "jiǎozi",
    desc: "Tinh Hoa Ẩm Thực",
    color:
      "from-orange-600/80 to-red-950/90 text-orange-400 border-orange-500/30",
    bgImage: cover1,
  },
  {
    title: "HSK 4 Standard",
    badge: "HSK 4",
    chars: "未来",
    pinyin: "wèilái",
    desc: "Làm Chủ Ngữ Pháp",
    color:
      "from-indigo-600/80 to-purple-950/90 text-indigo-400 border-indigo-500/30",
    bgImage: cover2,
  },
  {
    title: "Từ Vựng HSK 5",
    ...
    chars: "智慧",
    pinyin: "zhìhuì",
    desc: "Bứt Phá Từ Vựng",
    color:
      "from-fuchsia-600/80 to-fuchsia-950/90 text-fuchsia-400 border-fuchsia-500/30",
    bgImage: cover3,
  },
  {
    title: "Thành Ngữ Trung Hoa",
    badge: "Thành Ngữ",
    chars: "成语",
    pinyin: "chéngyǔ",
    desc: "Thành Ngữ Ý Nghĩa",
    color:
      "from-yellow-600/80 to-yellow-950/90 text-yellow-400 border-yellow-500/30",
    bgImage: cover1,
  },
  {
    ...
    chars: "商贸",
    pinyin: "shāngmào",
    desc: "Thương Mại Thực Tế",
    color:
      "from-slate-700/80 to-slate-900/90 text-slate-400 border-slate-500/30",
    bgImage: cover2,
  },
  {
    title: "Giáo Trình HSK 6",
    badge: "HSK 6",
    chars: "高峰",
    pinyin: "gāofēng",
    desc: "Chinh Phục Đỉnh Cao",
    color:
      "from-violet-750/80 to-slate-950/90 text-violet-400 border-violet-500/30",
    bgImage: cover3,
  },
];
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center w-full px-4 py-8">
        <div className="w-full max-w-[420px] bg-[#fdfbf7]/85 backdrop-blur-3xl border border-[#d6cfc7] rounded-2xl p-8 md:p-10 shadow-[0_24px_50px_rgba(0,0,0,0.15),0_0_80px_rgba(175,56,43,0.05)] flex flex-col gap-6 font-sans">
          <div className="space-y-1">
            ...
            <p className="text-sm text-[#7e746b] font-medium whitespace-pre-line">
              {isSignUp
                ...
                : "Chào mừng bạn quay trở lại Hanora"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isSignUp && (
              <div className="space-y-1.5">
                <label className="text-[11px] font-black uppercase tracking-widest text-[#af382b] ml-1">
                  Họ và tên
                </label>
                <input
                  type="text"
            ...
            {!isSignUp && (
              <div className="flex items-center justify-between text-xs text-[#7e746b] pt-1 px-1">
                ...
                <button
                  type="button"
                  className="hover:underline hover:text-[#af382b] font-medium transition-colors"
                >
                  Quên mật khẩu?
                </button>
              </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-[#a89f95]">
              Hoặc
            </span>
            <div className="h-px flex-1 bg-[#d6cfc7]" />
          </div>
          ...
          <div className="flex flex-col gap-3">
            <div className="text-center text-[11px] font-black uppercase tracking-[0.3em] text-[#a89f95]">
            ...
            {!GOOGLE_CLIENT_ID && (
              <p className="text-[11px] text-[#af382b] text-center">
                Chưa cấu hình Google Client ID. Vui lòng thêm biến môi trường
                `VITE_GOOGLE_CLIENT_ID` và khởi động lại server.
              </p>
            )}
            {!googleReady && !googleError && GOOGLE_CLIENT_ID && (
              <div className="flex items-center justify-center gap-2 text-xs text-[#7e746b]">
