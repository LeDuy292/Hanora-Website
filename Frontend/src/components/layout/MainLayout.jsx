...
export function MainLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans relative overflow-x-hidden">
      ...
      {/* Main Content Pane */}
      <main className={`flex-grow ${displayBanner ? 'pt-32 md:pt-36' : 'pt-24 md:pt-28'} pb-28 xl:pb-16 mx-auto relative z-10 transition-all duration-300 ${isReaderPage ? 'w-full max-w-none px-1 sm:px-2 lg:px-3' : 'max-w-[1600px] 2xl:max-w-[1800px] w-full sm:w-[96%] px-3 sm:px-5 lg:px-6'}`}>
